...
import type { AppBuildInfo } from './types.js';
/**
 ...
 */
export declare function getBinaryPath(packageJsonPath: string, appBuildInfo: AppBuildInfo, p?: NodeJS.Process): Promise<string>;
/**
